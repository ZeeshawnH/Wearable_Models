#!/usr/bin/env python3
"""
Train SharedAdaptiveConvClassifier (AMS) on PhysioNet ECG data.
Usage: python scripts/train_ams.py [--epochs 500] [--lr 0.00005] [--patience 50]
"""
import argparse
import os
import sys
...
import torch
from models import SharedAdaptiveConvClassifier
...
MODEL_NAME = "SharedAdaptiveConvClassifier"
...
def main():
    ...
    # Model
    target_length = args.cycle_num * 8
    model = SharedAdaptiveConvClassifier(
