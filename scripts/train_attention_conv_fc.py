#!/usr/bin/env python3
"""
Train AttentionConvFcClassifier on PhysioNet ECG data.
Usage: python scripts/train_attention_conv_fc.py [--epochs 500] [--lr 0.00005] [--patience 50]
"""
import argparse
import os
import sys
...
import torch
from models import AttentionConvFcClassifier
...
MODEL_NAME = "AttentionConvFcClassifier"
...
def main():
    ...
    model = AttentionConvFcClassifier(
