#!/usr/bin/env python3
"""
Train ConvFcClassifier on PhysioNet ECG data.
Usage: python scripts/train_conv_fc.py [--epochs 500] [--lr 0.00005] [--patience 50]
"""
import argparse
import os
import sys
...
import torch
from models import ConvFcClassifier
